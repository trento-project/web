...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/clusters/events/cluster_discovered_health_changed.ex#L4)
...
```elixir
@type t() :: %Trento.Clusters.Events.ClusterDiscoveredHealthChanged{
  cluster_id: term(),
