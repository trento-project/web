defmodule TrentoWeb.OpenApi.V1.Schema.DiscoveryEvent do
  ...
  OpenApiSpex.schema(
    %{
      title: "DiscoveryEvent_V1",
      description:
        "Represents a discovery event generated by an agent, including its type, payload, and associated metadata for infrastructure monitoring.",
      type: :object,
