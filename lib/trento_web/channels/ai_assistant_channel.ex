...
defmodule TrentoWeb.AIAssistantChannel do
  ...
  # Handles user hitting Stop in the composer
  @impl true
  def handle_in(
        "cancel_run",
        _payload,
  ...
  # The user abandoned the thread by clicking "New chat".
  # Stops the agent instead of waiting for the inactivity timeout.
  @impl true
  def handle_in(
        "abandon_thread",
        _payload,
