...
defmodule Trento.ActivityLog.Correlations.UnscopedCorrelations do
  ...
  @suse_multi_linux_manager_settings "suse_multi_linux_manager_settings"
  @default_ttl 15_000
  ...
  def correlation_key(:suse_multi_linux_manager_settings), do: @suse_multi_linux_manager_settings
