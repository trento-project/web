...
defmodule Trento.ActivityLog.SeverityLevel do
  ...
  @severity_level_mapping %{
    ...
    "profile_update" => :info,
    "personal_access_token_creation" => :info,
    "personal_access_token_deletion" => :warning,
    "personal_access_token_admin_deletion" => :warning,
    "resource_tagging" => :info,
    "resource_untagging" => :info,
    "api_key_generation" => :info,
    "saving_smlm_settings" => :info,
    "changing_smlm_settings" => :info,
    "clearing_smlm_settings" => :warning,
