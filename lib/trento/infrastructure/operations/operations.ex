defmodule Trento.Infrastructure.Operations do
  ...
  def map_operation_type("clusterresourcerefresh@v1"), do: :cluster_resource_refresh
  ...
  def map_operation_type("hostreboot@v1"), do: :reboot
  ...
  def map_operation(:cluster_resource_refresh), do: "clusterresourcerefresh@v1"
  ...
  def map_operation(:reboot), do: "hostreboot@v1"
