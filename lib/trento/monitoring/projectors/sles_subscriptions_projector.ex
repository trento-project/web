defmodule Trento.Monitoring.SlesSubscriptionsProjector do
  @moduledoc """
  ...
  alias Trento.Monitoring.Domain.Events.SlesSubscriptionsUpdated

  alias Trento.Monitoring.SlesSubscriptionReadModel
