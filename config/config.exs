...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js js/tronto.jsx --bundle --target=es2016 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
...
config :tronto, Tronto.Monitoring.Heartbeat, interval: :timer.seconds(5)
...
config :tronto, Tronto.Scheduler,
  jobs: [
    heartbeat_check: [
      ...
      task: {Tronto.Monitoring.Heartbeat, :dispatch_heartbeat_failed_commands, []},
