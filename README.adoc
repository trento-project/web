...
See link:https://github.com/trento-project/web/blob/main/guides/alerting/alerting.adoc[related documentation] for more
information.
...
https://github.com/trento-project/docs/blob/main/guides/manual-installation.adoc[Installationof Trento] guide.
...
link:https://github.com/trento-project/web/blob/main/guides/development/hack_on_the_trento.adoc[hack on the Trento Web]
guide.
