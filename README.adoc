...
It’s meant to complement link:_https://www.suse.com/products/sles-for-sap/[SUSE Linux Enterprise
...
See the xref:Architecture/trento-architecture.adoc[architecture document] for additional details.
