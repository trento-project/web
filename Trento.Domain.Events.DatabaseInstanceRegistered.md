...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/sap_systems/events/legacy/database_instance_registered.ex#L4)
...
```elixir
@type t() :: %Trento.Domain.Events.DatabaseInstanceRegistered{
  features: term(),
  health: term(),
  host_id: term(),
  http_port: term(),
