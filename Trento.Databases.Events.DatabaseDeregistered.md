...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/databases/events/database_deregistered.ex#L4)
...
```elixir
@type t() :: %Trento.Databases.Events.DatabaseDeregistered{
  database_id: term(),
