...
describe('ProfileForm', () => {
  ...
  it.each([
    ...
    'analytics eula accepted value is updated properly when the profile is saved',
    async ({ analyticsEnabled, analyticsEulaAccepted, updateValue }) => {
      const {
        username,
        fullname,
        email,
