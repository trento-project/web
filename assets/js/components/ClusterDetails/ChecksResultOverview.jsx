...
const ChecksResultOverview = ({ passing = 0, warning = 0, critical = 0 }) => {
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col self-start w-full px-4 mt-2">
        <CheckResult value={passing} result="passing" />
        <CheckResult value={warning} result="warning" />
        <CheckResult value={critical} result="critical" />
      </div>
    </div>
  );
};
