...
export const SAVING_SMLM_SETTINGS = 'saving_smlm_settings';
export const CHANGING_SMLM_SETTINGS = 'changing_smlm_settings';
export const CLEARING_SMLM_SETTINGS = 'clearing_smlm_settings';
