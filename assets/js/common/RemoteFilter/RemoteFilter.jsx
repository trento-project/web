 ...
 */
function RemoteFilter({ options, title, value = [], onChange}) {
  const ref = useRef();
...
const mapStateToProps = (state) => ( {
  options: !state.activityLog.users ? ["Loading"] :  state.activityLog.users
});


export default connect(mapStateToProps)(RemoteFilter);
