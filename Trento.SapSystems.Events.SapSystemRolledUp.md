...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/sap_systems/events/sap_system_rolled_up.ex#L4)
...
```elixir
@type t() :: %Trento.SapSystems.Events.SapSystemRolledUp{
  sap_system_id: term(),
  snapshot: term(),
  version: term()
}
