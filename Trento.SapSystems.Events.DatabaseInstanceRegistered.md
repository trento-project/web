...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/databases/events/legacy/database_instance_registered.ex#L4)
...
```elixir
@type t() :: %Trento.SapSystems.Events.DatabaseInstanceRegistered{
  features: term(),
  health: term(),
  host_id: term(),
  http_port: term(),
