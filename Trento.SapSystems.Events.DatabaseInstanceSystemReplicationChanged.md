...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/databases/events/legacy/database_instance_system_replication_changed.ex#L4)
...
```elixir
@type t() :: %Trento.SapSystems.Events.DatabaseInstanceSystemReplicationChanged{
  host_id: term(),
