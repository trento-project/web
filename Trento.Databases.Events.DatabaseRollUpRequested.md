...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/databases/events/database_roll_up_requested.ex#L4)
...
```elixir
@type t() :: %Trento.Databases.Events.DatabaseRollUpRequested{
  database_id: term(),
  snapshot: term(),
  version: term()
}
