...
const stalenessBannerName = 'An agent in one of the database hosts is not reporting since';
...
export const databaseSiteIsMarkedAsStale = () =>
  basePage.elementIsMarkedStale(siteReplicationHeader(selectedDatabase.Sites[0].Name));

export const databaseSiteIsMarkedInSync = () =>
  basePage.elementIsMarkedInSync(siteReplicationHeader(selectedDatabase.Sites[0].Name));
