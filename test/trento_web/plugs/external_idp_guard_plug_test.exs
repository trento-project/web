defmodule TrentoWeb.Plugs.ExternalIdpGuardPlugTest do
  ...
  describe "call/2" do
    test "should return 501 when external idp integration is enabled as oidc", %{conn: conn} do
    ...
    test "should return 501 when external idp integration is enabled as oauth2", %{conn: conn} do
      Application.put_env(:trento, :oauth2, enabled: true)
