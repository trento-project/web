  ...
  describe "parameters_schema/1" do
    test "returns empty object when no parameters and no request body" do
      ...
      assert OpenApiToolBuilder.parameters_schema(op) == %{
               "type" => "object",
               "properties" => %{}
               # 'required' is intentionally omitted when empty so that
               # ChatGoogleAI's exact-match deletion strips the empty object.
               # This invariant is load-bearing — do not relax it.
             }
    end
