defmodule Trento.Databases.Events.DatabaseInstanceMarkedAbsentTest do
  use Trento.AggregateCase, aggregate: Trento.Databases.Database, async: true

  alias Trento.Databases.Events.DatabaseInstanceMarkedAbsent

  describe "DatabaseInstanceMarkedAbsent event upcasting, version 2" do
    test "should upcast event id when a legacy event is received" do
      database_id = Faker.UUID.v4()

      assert %{"version" => 2, "database_id" => database_id} ==
               DatabaseInstanceMarkedAbsent.upcast(
