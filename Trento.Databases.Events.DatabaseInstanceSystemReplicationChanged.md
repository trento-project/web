...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/databases/events/database_instance_system_replication_changed.ex#L4)
...
```elixir
@type t() :: %Trento.Databases.Events.DatabaseInstanceSystemReplicationChanged{
  database_id: term(),
  host_id: term(),
