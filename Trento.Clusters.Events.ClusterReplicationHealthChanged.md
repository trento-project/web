...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/clusters/events/cluster_replication_health_changed.ex#L4)
...
```elixir
@type t() :: %Trento.Clusters.Events.ClusterReplicationHealthChanged{
  cluster_id: term(),
