...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/sap_systems/events/sap_system_roll_up_requested.ex#L4)
...
```elixir
@type t() :: %Trento.SapSystems.Events.SapSystemRollUpRequested{
  sap_system_id: term(),
  snapshot: term(),
  version: term()
}
