...
*Heartbeat* - `+HOST_HEARTBEAT_INTERVAL+` (agent heartbeat interval in seconds, default: `5`) -
`+HOST_HEARTBEAT_ALLOWED_MISSED+` (number of missed heartbeats allowed before marking a host as unhealthy, default: `0`)
