...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/sap_systems/events/application_instance_deregistered.ex#L4)
...
```elixir
@type t() :: %Trento.SapSystems.Events.ApplicationInstanceDeregistered{
