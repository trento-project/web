...
[🔗](https://github.com/trento-project/web/blob/main/lib/trento/sap_systems/events/legacy/sap_system_rolled_up.ex#L4)
...
```elixir
@type t() :: %Trento.Domain.Events.SapSystemRolledUp{
  sap_system_id: term(),
  snapshot: term(),
  version: term()
}
